...
- **`cmd/issue-cli/main.go`** — minimal arg parser, dispatches to `internal/cli`. Subcommands: `list`/`ls`, `new`, `edit`, `show`, `next`, `help`. No flag library at the top level; subcommands use `flag.NewFlagSet`.
